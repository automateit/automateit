...
AutomateIt lets you write recipes that encapsulate your system setup and maintenance tasks into portable, repeatable and maintainable code. These recipes are so easy to understand that any UNIX user can read them without additional training. Yet when you need it, AutomateIt is the most powerful and feature-packed tool available. You can quickly adapt it to your unique needs by writing plugins with the embedded, full-featured programming language.
